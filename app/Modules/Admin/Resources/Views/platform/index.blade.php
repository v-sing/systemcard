                                            ...
                                            @switch($item2->type)
                                                ...
                                                <span
                                                        ...
                                                        <textarea name="{{$item2->name}}[{{$item2->name}}]"
                                                                  lay-verify="{{$item2->rule}}"
                                                                  class="form-control  layui-hide" cols="30"
                                                                  rows="5">{{$item2->value}}</textarea>
                                                    </dl>
                                                </td>
                                                @break
                                                @case('string')
                                                    ...
                                                    <div class="layui-col-md9">
                                                        <div class="@if(!$item2->tip) layui-input-block @else layui-input-line @endif">
                                                            <input type="text" name="{{$item2->name}}[{{$item2->name}}]"
                                                                   placeholder=""
                                                                   autocomplete="off" value="{{$item2->value}}"
                                                                   lay-verify="{{$item2->rule}}"
                                                                   class="layui-input">
                                                        </div>
                                                        @if($item2->tip)
                                                        ...
                                                        <div class="layui-input-block">
                                                            @foreach($item2->content as $key3=> $item3)
                                                                <input type="checkbox"
                                                                       ...
                                                                       title="{{$item3['value']}}"
                                                                       value="{{$item3['key']}}"
                                                                       @if(in_array($item3['key'],explode(',',$item2->value))) checked @endif>
                                                            @endforeach
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div class="layui-col-md9">
                                                        <div class="layui-input-block">
                                                            <input type="checkbox"
                                                                   name="{{$item2->name}}[{{$item2->name}}]"
                                                                   lay-skin="switch" @if($item2->value)checked @endif>
                                                        </div>
                                                    </div>
                                                </td>
                                                @break
                                                        ...
                                                        <div class="layui-input-block">
                                                            @foreach($item2->content as $key3=> $item3)
                                                                <input type="radio"
                                                                       ...
                                                                       title="{{$item3['value']}}"
                                                                       value="{{$item3['key']}}"
                                                                       @if($item3['key']==$item2->value) checked @endif>
                                                            @endforeach
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <textarea name="{{$item2->name}}[{{$item2->name}}]" placeholder="请输入内容"
                                                          lay-verify="{{$item2->rule}}"
                                                          class="layui-textarea">{{$item2->value}}</textarea>
                                                        </div>
                                                    </div>
                                                    @if($item2->tip)
                                                        <div class="layui-form-mid layui-word-aux">{{$item2->tip}}</div> @endif
                                                            ...
                                                            <select name="{{$item2->name}}[{{$item2->name}}]"
                                                                ...
                                                                @foreach($item2->content as $key3=> $item3)
                                                                    <option value="{{$item3['key']}}"
                                                                            @if(in_array($item3['key'],explode(',',$item2->value))) selected @endif>{{$item3['value']}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <td>
                                                    <div class="layui-col-md9">
                                                        <div class="layui-input-block">
                                                            <select name="{{$item2->name}}[{{$item2->name}}]"
                                                                    xm-select="selectId" lay-verify="{{$item2->rule}}">
                                                                <option value=""></option>
                                                                @foreach($item2->content as $key3=> $item3)
                                                                    <option value="{{$item3['key']}}"
                                                                            @if(in_array($item3['key'],explode(',',$item2->value))) selected @endif>{{$item3['value']}}</option>
                                                ...
                                                @break
                                            @endswitch
                                            <td><span>{</span><span>{</span>{{$item2->group}}.{{$item2->name}}
                                                <span>}}</span>
                    ...
                    <div class="layui-tab-item">
                        <form class="layui-form" action="">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="value" placeholder="请输入变量值"
                                           autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="rule" placeholder="请输入验证规则"
                                           autocomplete="off" class="layui-input">
                                </div>
...
@section('js')
    <script>
        layui.extend({
            fieldlist: "/lib/layui/lay/modules/fieldlist",
            formSelects: '/lib/layui/lay/modules/formSelects'
